                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildDetailRow('Violation Tracking Number',
                          appeal.violationTrackingNumber),
                      ...
                      if (appeal.status.toLowerCase() != 'pending' &&
                          appeal.statusReason != null &&
                          appeal.statusReason!.isNotEmpty) ...[
                        const SizedBox(height: 16),
                        Text(
                          'Admin Feedback',
                          style: TextStyle(
                      ...
                      if (appeal.uploadedDocuments.isNotEmpty ||
                          appeal.supportingDocuments.isNotEmpty) ...[
                        const SizedBox(height: 16),
                        Text(
                          'Attached Documents',
                          style: TextStyle(
                  ...
                  if (appeal.status.toLowerCase() == 'pending')
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: const Text('Delete Appeal'),
                        style: ElevatedButton.styleFrom(
                          backgroundColor: Colors.red,
                          foregroundColor: Colors.white,
